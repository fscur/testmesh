...
#define PK_DEBUG_versioning_behaviour_c         ((PK_DEBUG_versioning_t) 25850)
#define PK_DEBUG_versioning_incorrect_c         ((PK_DEBUG_versioning_t) 25851)
#define PK_DEBUG_versioning_mixed_c             ((PK_DEBUG_versioning_t) 25852)
...
/* PK_DEBUG_behaviours_start_o_m */

#define PK_DEBUG_behaviours_start_o_m(options)                   \
       ((options).o_t_version = 1,                               \
        (options).versioning = PK_DEBUG_versioning_behaviour_c   \
       )
...
PK_linkage_m PK_ERROR_code_t PK_DEBUG_behaviours_start
(
/* received */
...
PK_linkage_m PK_ERROR_code_t PK_DEBUG_behaviours_stop
(
void
);
/*
Stops the debug of the behaviours mechanism.
*/
